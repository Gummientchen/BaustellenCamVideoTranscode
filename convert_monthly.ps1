...
..\ffmpeg.exe -r 60 -f image2 -s 1920x1080 -i %05d.jpg -vcodec libx264 -crf 20 -vf scale=3840:2160:flags=lanczos,tpad=stop_duration=20 -pix_fmt yuv420p ..\output\month.mp4
