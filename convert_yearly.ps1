...
..\ffmpeg.exe -r 30 -f image2 -s 1920x1080 -i %05d.jpg -vcodec libx264 -crf 20 -vf "setpts=(15)*PTS,scale=3840:2160:flags=lanczos" -pix_fmt yuv420p ..\output\yeartmp.mp4
